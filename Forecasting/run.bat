...
python trainer.py --daily --dataset %dataset% --epochs %epochs2% --input_days %input_days% --output_days %output_days% --modeltype LSTM_Simple_WO_Regions --preprocessing Unfiltered --undersampling Reduce --lr 0.002
python trainer.py --daily --dataset %dataset% --epochs %epochs2% --input_days %input_days% --output_days %output_days% --modeltype LSTM_Simple_WO_Regions --preprocessing Filtered --undersampling Reduce --lr 0.004
rem python trainer.py --daily --dataset %dataset% --epochs %epochs2% --input_days %input_days% --output_days %output_days% --modeltype LSTM4EachDay_WO_Regions --preprocessing Unfiltered --undersampling Reduce --lr 0.002
rem python trainer.py --daily --dataset %dataset% --epochs %epochs2% --input_days %input_days% --output_days %output_days% --modeltype LSTM4EachDay_WO_Regions --preprocessing Filtered --undersampling Reduce --lr 0.004
rem python trainer.py --daily --dataset %dataset% --epochs %epochs2% --input_days %input_days% --output_days %output_days% --modeltype Dense_WO_regions --preprocessing Unfiltered --undersampling Reduce --lr 0.002
rem python trainer.py --daily --dataset %dataset% --epochs %epochs2% --input_days %input_days% --output_days %output_days% --modeltype Dense_WO_regions --preprocessing Filtered --undersampling Reduce --lr 0.004
